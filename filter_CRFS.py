...
from spacy.matcher import Matcher # match sequence of tokens, based on patter rules
...
class Filter():
	...
	def __init__(self):
		...
		dicts = pickle.load(open('dict_CRFS.pkl', 'rb')) # List of foods and respective scientific names as well as chemical compounds that will be used for paper search
		...
		gen_dict = ['food', 'contaminant', 'database']
